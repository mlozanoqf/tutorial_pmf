...
The main objective of this document is to show how to extract, visualize and analyze financial data in the context of asset pricing, asset allocation and review some the most cutting edge technologies applications such as blockchain, using the powerful R programming language. 
