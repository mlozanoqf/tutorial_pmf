...
```{r fig.cap="The four individual assets."}
...
```{r fig.cap="Random method optimal portfolio."}
# Plot results.
...
```{r fig.cap="Random method optimal weights."}
...
```{r fig.cap="ROI method optimal portfolio."}
# Plot results.
...
```{r}
port_spec <- add.constraint(portfolio = port_spec, type = "return", 
                             return_target = 0.03414333)
set.seed(13)
opt_roi2 <- optimize.portfolio(fang, portfolio = port_spec,
                               optimize_method = "ROI", maxSR = TRUE,
                               rf = 0, trace = TRUE)
```


```{r fig.cap="ROI method optimal weights that targets the naïve portfolio expected return."}
...
```{r fig.cap="ROI method that targets the naïve portfolio expected return."}
# Plot results.
...
```{r fig.cap="Simulated returns of investment alternatives."}
# The boxplot.
...
```{r fig.cap="Simulated returns of investment alternatives. What really happened by 2017-01-30 in red."}
# The simulation.
boxplot(b, las = 2)
abline(h=0, lty = 2)
